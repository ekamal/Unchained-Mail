...
class DefaultController extends Controller
{
    ...
    function ajouterCampagneAction(Request $request) {
        ...
        if($form->isValid()) {
            ...
            $fields = array(
                'id' => $campagne->getId(),
                'lienOffre' => urlencode($campagne->getOffre()->getLien()),
                'lienImage' => urlencode($campagne->getOffre()->getCreative()),
                'lienUnsub' => urlencode("http://newofferz4u.com/unsublist")
            );
            $fields_string = '';
            $url = 'http://newofferz4u.com/addCamp.php';
